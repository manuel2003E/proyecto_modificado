...
@section('content')
<div class="container">
    <h2 class="text-center mb-4">Lista de Pagos</h2>
    <a href="{{ route('pagos.create') }}" class="btn btn-success mb-3">Registrar Pago</a>
        ...
        <tbody>
            @foreach($pagos as $pago)
                <tr>
                    ...
                    <td>{{ number_format($pago->credito->monto_credito, 2) }} USD</td>
                    <td>{{ number_format($pago->monto_pago, 2) }} USD</td>
...
<style>
    ...
    .btn-success {
        background-color: #28a745; /* Color del botón de registrar */
        border: none; /* Sin borde */
    }
